...
input int Stop_Loss   = 78; // Stop Loss (pips)
input int Take_Profit = 13; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Commodity Channel Index -----
input int Ind0Param0 = 37; // Period
input int Ind0Param1 = 0; // Level
...
input int Ind2Param0 = 5; // Period
input double Ind2Param1 = 0.2880; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 42736979; // Magic Number
...
void ManageOpen()
  {
   ...
   double ind0val3 = iCCI(NULL,0,Ind0Param0,PRICE_TYPICAL,3);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET MetaTrader-Demo; USDJPY; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":78,"takeProfit":13,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Commodity Channel Index","listIndexes":[6,5,0,0,0],"numValues":[37,0,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[4,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[5,0,0,0,0],"numValues":[5,0.288,0,0,0,0]}]} */
