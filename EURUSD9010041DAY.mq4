...
static input double Entry_Amount = 1; // Entry lots
...
input int Ind1Param0 = 43; // Period
input int Ind1Param1 = 20; // Level
static input string Ind2 = "------------";// ----- Stochastic Signal -----
input int Ind2Param0 = 15; // %K Period
input int Ind2Param1 = 13; // %D Period
input int Ind2Param2 = 6; // Slowing

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010017; // Magic Number
...
void ManageOpen()
  {
   ...
   double ind1val1 = iMFI(NULL,0,Ind1Param0,1);
   double ind1val2 = iMFI(NULL,0,Ind1Param0,2);
...
void ManageClose()
  {
   double ind2val1 = iStochastic(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,MODE_SMA,0,MODE_MAIN,1);
   double ind2val2 = iStochastic(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,MODE_SMA,0,MODE_SIGNAL,1);
   double ind2val3 = iStochastic(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,MODE_SMA,0,MODE_MAIN,2);
   double ind2val4 = iStochastic(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,MODE_SMA,0,MODE_SIGNAL,2);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":56,"takeProfit":70,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[5,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Money Flow Index","listIndexes":[1,0,0,0,0],"numValues":[43,20,0,0,0,0]}],"closeFilters":[{"name":"Stochastic Signal","listIndexes":[0,0,0,0,0],"numValues":[15,13,6,0,0,0]}]} */
