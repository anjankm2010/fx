...
input int Take_Profit = 10; // Take Profit (pips)
...
void ManageClose()
  {
   double ind2val1 = iMA(NULL,0,Ind2Param0,Ind2Param1,MODE_SMA,PRICE_CLOSE,1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":50,"takeProfit":50,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RVI Signal","listIndexes":[1,0,0,0,0],"numValues":[21,0,0,0,0,0]},{"name":"Momentum","listIndexes":[6,3,0,0,0],"numValues":[31,100,0,0,0,0]}],"closeFilters":[{"name":"Moving Average","listIndexes":[2,0,3,0,0],"numValues":[8,0,0,0,0,0]}]} */
