...
input int Ind2Param0 = 30000; // Level
static input string Ind3 = "------------";// ----- Commodity Channel Index -----
input int Ind3Param0 = 20; // Period 
input int Ind3Param1 = 200; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010018; // Magic Number
...
void ManageOpen()
  {
   ...
   double ind1val3 = iWPR(NULL,0,Ind1Param0,3);
...
void ManageClose()
  {
   ...
   double ind3val1 = iCCI(NULL,0,Ind3Param0,PRICE_TYPICAL,1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":51,"takeProfit":59,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Directional Indicators","listIndexes":[0,0,0,0,0],"numValues":[35,0,0,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[6,0,0,0,0],"numValues":[41,-20,0,0,0,0]}],"closeFilters":[{"name":"Volumes","listIndexes":[2,0,0,0,0],"numValues":[490347,0,0,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[2,5,0,0,0],"numValues":[33,168,0,0,0,0]}]} */
