...
input int Take_Profit = 40; // Take Profit (pips)
...
input int Ind1Param0 = 70; // Jaws period
input int Ind1Param1 = 13; // Jaws shift
input int Ind1Param2 = 13; // Teeth period
...
input double Ind2Param1 = 4; // Deviation

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010028; // Magic Number
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET MetaTrader-Demo; EURGBP; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":74,"takeProfit":13,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[5,0,3,0,0],"numValues":[39,0,0,0,0,0]}],"closeFilters":[{"name":"Alligator","listIndexes":[9,3,4,0,0],"numValues":[38,13,13,4,4,3]},{"name":"Bollinger Bands","listIndexes":[2,3,0,0,0],"numValues":[11,3.23,0,0,0,0]}]} */
