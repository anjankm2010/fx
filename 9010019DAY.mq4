...
input int Ind0Param0 = 40; // Period
input double Ind0Param1 = 0.5; // Deviation %
...
input int Ind2Param0 = 40; // Jaws period
input int Ind2Param1 = 15; // Jaws shift
input int Ind2Param2 = 15; // Teeth period
input int Ind2Param3 = 5; // Teeth shift
input int Ind2Param4 = 5; // Lips period
input int Ind2Param5 = 3; // Lips shift

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010019; // Magic Number
...
void ManageClose()
  {
   double ind1val1 = iADX(NULL,0,Ind1Param0,PRICE_CLOSE,0,1);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; GBPJPY; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":33,"takeProfit":93,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Envelopes","listIndexes":[4,3,0,0,0],"numValues":[32,0.17,0,0,0,0]}],"closeFilters":[{"name":"ADX","listIndexes":[2,0,0,0,0],"numValues":[24,28,0,0,0,0]},{"name":"Alligator","listIndexes":[7,3,4,0,0],"numValues":[38,15,15,5,5,3]}]} */
