...
input int Take_Profit = 20; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Moving Average -----
input int Ind0Param0 = 80; // Period
input int Ind0Param1 = 0; // Shift
static input string Ind1 = "------------";// ----- Alligator -----
input int Ind1Param0 = 55; // Jaws period
...
static input int Magic_Number = 9010014; // Magic Number
