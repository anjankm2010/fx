...
input int Ind0Param1 = 4; // %D Period
input int Ind0Param2 = 6; // Slowing
static input string Ind1 = "------------";// ----- Volumes -----
input int Ind1Param0 = 1000; // Level
static input string Ind2 = "------------";// ----- Average True Range -----
input int Ind2Param0 = 50; // Period
input double Ind2Param1 = 0.0001; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010021; // Magic Number
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; GBPUSD; H1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":95,"takeProfit":88,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[8,3,7,0,0,0]},{"name":"Volumes","listIndexes":[0,0,0,0,0],"numValues":[1000,0,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[3,0,0,0,0],"numValues":[50,0.0001,0,0,0,0]}]} */
