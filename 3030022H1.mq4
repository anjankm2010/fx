...
input int Ind0Param0 = 10; // %K Period
...
input int Ind1Param1 = 50; // Slow MA period

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010022; // Magic Number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":68,"takeProfit":67,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Stochastic Signal","listIndexes":[1,0,0,0,0],"numValues":[11,3,4,0,0,0]}],"closeFilters":[{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[13,41,0,0,0,0]}]} */
