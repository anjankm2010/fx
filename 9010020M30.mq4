...
static input double Entry_Amount = 0.02; // Entry lots
input int Stop_Loss   = 20; // Stop Loss (pips)
input int Take_Profit = 120; // Take Profit (pips)
...
input int Ind1Param1 = 30; // Level
static input string Ind2 = "------------";// ----- Force Index -----
input int Ind2Param0 = 57; // Period
static input string Ind3 = "------------";// ----- Stochastic -----
input int Ind3Param0 = 5; // %K Period
input int Ind3Param1 = 13; // %D Period
input int Ind3Param2 = 11; // Slowing
input int Ind3Param3 = 102; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 9010020; // Magic Number
...
void ManageOpen()
  {
   ...
   double ind1val3 = iRSI(NULL,0,Ind1Param0,PRICE_CLOSE,3);
   ...
   double ind2val1 = iForce(NULL,0,Ind2Param0,MODE_SMA,PRICE_CLOSE,1);
   double ind2val2 = iForce(NULL,0,Ind2Param0,MODE_SMA,PRICE_CLOSE,2);
   double ind2val3 = iForce(NULL,0,Ind2Param0,MODE_SMA,PRICE_CLOSE,3);
...
void ManageClose()
  {
   double ind3val1 = iStochastic(NULL,0,Ind3Param0,Ind3Param1,Ind3Param2,MODE_SMA,STO_LOWHIGH,MODE_MAIN,1);
   bool ind3long  = ind3val1 > Ind3Param3 + sigma;
   bool ind3short = ind3val1 < 100 - Ind3Param3 - sigma;
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; GBPJPY; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"stopLoss":100,"takeProfit":17,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Directional Indicators","listIndexes":[0,0,0,0,0],"numValues":[8,0,0,0,0,0]},{"name":"RSI","listIndexes":[7,3,0,0,0],"numValues":[13,30,0,0,0,0]},{"name":"Force Index","listIndexes":[7,0,0,0,0],"numValues":[56,0,0,0,0,0]}],"closeFilters":[{"name":"Stochastic","listIndexes":[2,0,0,0,0],"numValues":[4,11,11,82,0,0]}]} */
